...
public final class DatabaseContract {
    ...
    public static abstract class DatabaseEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_IS_STARRED = "isstarred";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " + DatabaseEntry.TABLE_NAME + " (" +
            ...
            DatabaseEntry.COLUMN_NAME_IS_STARRED + INTEGER_TYPE + COMMA_SEP + DatabaseEntry.COLUMN_NAME_NAME + TEXT_TYPE + COMMA_SEP +
